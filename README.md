...
6. average total number of attempts to get a background sequence from genome per one foreground sequence (default value 500)
...
12. average total number of attempts to get a background sequence from genome per one foreground sequence (default value 500)
